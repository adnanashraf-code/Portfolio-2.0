    ...
    <section id="skills" className="container reveal">
      ...
      <div className="grid-2">
        <div className="glass reveal" style={{ padding: "2rem" }}>
          <h3 style={{ marginBottom: "2rem", color: "var(--primary-cyan)" }}>
            Core Competencies
          </h3>
        ...
        >
          <div className="card glass">
            <h4 style={{ color: "var(--primary-cyan)", marginBottom: "1rem" }}>
              Web Dev
            </h4>
            <p style={{ fontSize: "0.9rem" }}>
              Responsive Web Design, UI Fundamentals, Client Side State
