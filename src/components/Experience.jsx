  ...
  const experiences = [
    {
      ...
      details: [
        "Provided technical support to 100+ customers daily via chat and email, ensuring quick issue resolution.",
        "Maintained approximately 98% customer satisfaction by delivering timely and accurate troubleshooting solutions.",
        "Recognized as CPH King of the Month for top email support performance and productivity.",
